...
if __name__ == '__main__' :
    resnet_path = '/state/heyang/ZHEDA_PROJECT_DATA/models/tcps_resnet_model_alpha_0.2/TCPS_resnet18_100_alpha_0.2.pth'
    resnet_model=resnet_model(resnet_path,112)
    data_path = '/state/heyang/ZHEDA_PROJECT_DATA/datas/tcps_data/train_data/resnet_input_data/test/Red/'
