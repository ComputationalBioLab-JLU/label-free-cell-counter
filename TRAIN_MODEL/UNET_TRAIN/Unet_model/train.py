...
class train_model():
    ...
    def tensor_to_pic(self,tensor,pic_type='RGB'):
        ...
        return(pil_img)
    def test_model(self,net_model,test_dataset,test_batch_size,sample_save_path,save_sample,gpu,check_bound=10):
...
#                if iter_number % 1000 == 0:
            sample_save_path='{}/{}'.format(pic_save_path,epoch)
...
#                                           gpu= True)
        ...
        log_file.write('Best iter :{} ;  Best val acc :  {}\n'.format(best_epoch,best_acc))
        log_file.close()
